...
<p style="text-align:center"><br/><img src="https://mydevices.com/wp-content/uploads/2017/05/Caynne-API-Getting-Started.png" width="660" height="563" alt="API Getting Started auth"><br/><br/></p>
...
An application is automatically created when a user visits the **``https://cayenne.mydevices.com/cayenne/dashboard/apps``** page.
An application ID and KEY (respectively Client Id and Client Secret in OAuth terminologie) is generated and will never change for a specific user. Use these credentials to get your token or to for any flow described below, everywhere Client Id and Client Secret are mentionned.
...
This can be done directly on the cayenne <a href="https://cayenne.mydevices.com/cayenne/dashboard/apps" target="_blank">Create App</a> page.
...
```
GET https://accounts.mydevices.com/auth/realms/cayenne/protocol/openid-connect/auth?response_type=code&client_id=<client id>&redirect_uri=<redirect uri>&scope=<scopes>&state=<state>
```
