...
**Note:** *The Arduino Ethernet Shield 2 uses the W5500 ethernet chipset, so use select the **Ethernet Shield W5500** when adding your device in Cayenne.*
...
Cayenne can be used with a range of **LoRa devices**, supported on various different LoRa network providers. You can find a list of <a href="https://mydevices.com/cayenne/marketplace/" target="_blank">LoRa tehcnology devices supported by Cayenne</a> on the Cayenne **Marketplace**. The Marketplace includes details on each device, **Datasheet**, **User Guides** and **Purchase** links in case you need hardware for your use.

## Actuators

Cayenne can be used with a range of **Actuators**. You can find a list of <a href="https://mydevices.com/cayenne/marketplace/" target="_blank">Actuators supported by Cayenne</a> on the Cayenne **Marketplace**. The Marketplace includes details on each device, **Datasheet**, **User Guides** and **Purchase** links in case you need hardware for your use.
