...
### Using Arduino Ethernet & WiFi Shield
...
* Some TMP102 sensors allow you to change the default address by bridging the address pin. Some versions, such as the one used in this example, are hardwired to a default address of 0x48. Refer to the specifications for your chip for more details.
* Make sure Raspberry Pi is powered off when connecting wires.
* When using a GPIO ribbon cable, make sure the power wire (it’s a different color than the others) is connected to the corner of your Raspberry Pi and the top of your Pi cobbler.
* The provided diagram is just an example of how to connect the sensor. There are many ways to connect sensors and extensions, so try what works best for you!
* Some full-size breadboards (used in diagrams below) have a powerline that is separated in the middle. If this is the case, be sure your sensors are connected on the same half of the breadboard as your Pi Cobbler.
...
* Some TMP102 sensors allow you to change the default address by bridging the address pin. Some versions, such as the one used in this example, are hardwired to a default address of 0x48. Refer to the specifications for your sensor for more details.
* The provided diagram is just an example of how to connect the hardware. There are many ways to connect devices, so try what works best for you!
* Although there are many Arduino boards, the one used in this example is the Arduino Uno.
...
*   [VCNL4000](#supported-hardware-sensors-wiring-tutorials-luminosity-vcnl4000)
*   [TSL2561](#supported-hardware-sensors-wiring-tutorials-luminosity-tsl2561)
*   [Photoresistor](#supported-hardware-sensors-wiring-tutorials-luminosity-photoresistor)
...
Use the following diagram to connect a **TSL2561 Luminosity sensor**.

A couple of notes before you get started:

*   The TSL2561 sensor allows you to change the default address by bridging the address pin. Leaving the address pin floating (unconnected) will give you the default address, 0x39 in this example. Refer to the specifications for your chip for more details.
*   Make sure Raspberry Pi is powered off when connecting wires.
*   When using a GPIO ribbon cable, make sure the power wire (it’s a different color than the others) is connected to the corner of your Raspberry Pi and the top of your Pi cobbler.
*   The provided diagram is just an example of how to connect the sensor. There are many ways to connect sensors and extensions, so try what works best for you!
*   Some full-size breadboards (used in diagrams below) have a powerline that is separated in the middle. If this is the case, be sure your sensors are connected on the same half of the breadboard as your Pi Cobbler.
...
Use the following diagram to connect your **TSL2561 Luminosity sensor**.

A couple of notes before you get started:

*   The TSL2561 sensor allows you to change the default address by bridging the address pin. Leaving the address pin floating (unconnected) will give you the default address, 0x39 in this example. Refer to the specifications for your sensor for more details.
*   The provided diagram is just an example of how to connect the hardware. There are many ways to connect devices, so try what works best for you!
*   Although there are many Arduino boards, the one used in this example is the Arduino Uno.
...
*   The Photoresistor uses analog output, so you will need to use the analog pins on the Arduino.
*   In this example, we are using a 5v power supply from the Arduino, but we could use the 3.3v as well.
*   The provided diagram is just an example of how to connect the hardware. There are many ways to connect devices, so try what works best for you!
*   Although there are many Arduino boards, the one used in this example is the Arduino Uno.
...
##### Pressure
*   [BMP180](#supported-hardware-sensors-wiring-tutorials-temperature-bmp180)
*   [Analog Load Pressure](#supported-hardware-sensors-wiring-tutorials-pressure-analog-load)
...
*   The Proximity Sensor uses analog output, so you will need to use the analog pins on the Arduino.
*   Depending upon the pressure sensor used, additional components may be required to properly calibrate the sensor. For an example of using op-amps to calibrate a Flexi-Force sensor see the [following video](https://youtu.be/VtxFtzWlTgg).
*   The provided diagram is just an example of how to connect the hardware. There are many ways to connect devices, so try what works best for you!
*   Although there are many Arduino boards, the one used in this example is the Arduino Uno.
...
##### Proximity/Distance
[Analog Distance](#supported-hardware-sensors-wiring-tutorials-proximitydistance-analog-distance)
...
Use the following diagram to connect your **Analog Proximity Sensor**.
...
#### Motion
[Digital Motion](#supported-hardware-sensors-wiring-tutorials-motion-digital-motion-sensor)
...
Use the following diagram to connect your **PIR Digital Motion Sensor**.
...
#### Generic
[Digital Input](#supported-hardware-sensors-wiring-tutorials-generic-digital-input)
[Analog Input](#supported-hardware-sensors-wiring-tutorials-generic-analog-input)
...
*   The provided diagram is just an example of how to connect the sensor. There are many ways to connect sensors and extensions, so try what works best for you! In this example, we will vary the input by using a pushbutton.
*   Make sure Raspberry Pi is powered off when connecting wires.
*   When using a GPIO ribbon cable, make sure the power wire (it’s a different color than the others) is connected to the corner of your Raspberry Pi and the top of your Pi cobbler.
*   Some full-size breadboards (used in diagrams below) have a powerline that is separated in the middle. If this is the case, be sure your sensors are connected on the same half of the breadboard as your Pi Cobbler.
...
Use the following diagram to use one of the **Arduino Digital Inputs**.
...
Use the following diagram to connect an **Analog Input**.
...
Use the following diagram to connect an **Analog Input**. For this example, we’ll connect a Photoresistor.
